...
![증감 연산자](../../images/java/live-study/chapter-03/3.png)
...
![나머지 연산의 버림](../../images/java/live-study/chapter-03/4.png)
...
![연산결과의 의도치 못한 오버플로우](../../images/java/live-study/chapter-03/5.png)
...
![리터럴 연산](../../images/java/live-study/chapter-03/6.png)
...
![나머지 연산의 버림](../../images/java/live-study/chapter-03/7.png)
...
![홀수-짝수 구별 1](../../images/java/live-study/chapter-03/8.png)

그렇다면 음수의 경우에도 제대로 홀수와 짝수를 구별하려면 어떻게 해야할까? 이때는 아래 이미지와 같이 나머지 연산의 결괏값을 `1` 과 비교하는 것이 아닌 `0` 과 비교하면 된다.

![홀수-짝수 구별 2](../../images/java/live-study/chapter-03/9.png)
...
![논리 연산자](../../images/java/live-study/chapter-03/10.jpg)
...
![홀수-짝수 구별 3](../../images/java/live-study/chapter-03/11.png)
...
![쉬프트 연산자 1](../../images/java/live-study/chapter-03/12.jpg)

반대로 아래 이미지와 같이 `-8 >> 2` 인 경우 `-8` 의 2진수를 오른쪽으로 `2` 자리 이동시키고 저장범위를 벗어난 값은 버려져 빈자리는 `1` 로 채워진 뒤 결괏값을 얻게 된다.

```Java hl_lines="46-54"
{!../docs_src/java/live-study/Chapter03.java!}
```

![쉬프트 연산자 2](../../images/java/live-study/chapter-03/13.png)
...
![대입 연산자의 lvalue](../../images/java/live-study/chapter-03/14.png)
...
![조건 연산자](../../images/java/live-study/chapter-03/15.png)
